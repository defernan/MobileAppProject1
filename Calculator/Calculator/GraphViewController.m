...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    ...
    //[segue.destinationViewController setProgram:self.program];

    //[self setGraphView:self.graphView];
}
...
- (void) splitViewController:(UISplitViewController *)svc 
    ...
    //[[self.splitViewController.viewControllers lastObject] removeSplitViewBarButtonItem:nil];
